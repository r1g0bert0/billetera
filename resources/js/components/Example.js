...
export default class Example extends Component {
    ...
    async handleSubmit(e){
        e.preventDefault()//evita que se note el recargado de la pagina
        //console.log('seding...')
        try {
            let config={
                method:'POST',
    ...
    handleChange(e){//funcion que escucha todos los eventos
    ...
    async componentDidMount(){//para llamadas a apis
        try {
